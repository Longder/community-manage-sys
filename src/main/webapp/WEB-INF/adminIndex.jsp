        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <sec:authorize access="hasRole('ROLE_ADMIN')">
                    ...
                    <li>
                        <a class="J_menuItem" href="${ctx}/admin/announcement/listAll" data-index="0">
                            <i class="fa fa-sticky-note"></i>
                            <span class="nav-label">公告管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${ctx}/admin/serverInfo/listAllServerInfo" data-index="0">
                            <i class="fa fa-gears"></i>
                            <span class="nav-label">服务信息管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${ctx}/admin/goods/listAll" data-index="0">
                            <i class="fa fa-shopping-cart"></i>
                            <span class="nav-label">商品管理</span>
                        </a>
                    </li>
                    <li>
                        <a class="J_menuItem" href="${ctx}/order/list" title="订单管理">
