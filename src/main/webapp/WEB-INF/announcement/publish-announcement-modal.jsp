                    ...
                    <div class="col-sm-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                <form id="add-announcement-form" method="post" class="form-horizontal"
                                      action="${ctx}/admin/announcement/publish">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            <button class="btn btn-primary" type="submit">确定发布</button>
