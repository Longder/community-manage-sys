...
import com.example.community.security.CustomerUserDetailsService;
import com.example.community.security.FormLoginSuccessHandler;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/admin/**","/order/**","/serverInfo").authenticated()//所有以admin开头的请求 都需要进行认证（就是登陆之后才能访问）
                .and()
                ...
                .and().logout().logoutUrl("/logout").logoutSuccessUrl("/")//登出的url是"/logout" 登出成功后访问"/"
